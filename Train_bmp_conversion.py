...
trainImage = "/storage/research/Intern19_v2/segmentation/Team 1/TrainingData/"
trainMask = "/storage/research/Intern19_v2/segmentation/Team 1/TrainingDataMasks/"
...
def preparetraindata():
    for i in range(0, 131, 1):
        seg = sitk.ReadImage("/storage/research/Intern19_v2/segmentation/Team 1/TrainingDataMasks/segmentation-" + str(i) + ".nii", sitk.sitkUInt8)
        segimg = sitk.GetArrayFromImage(seg)
        src = load_itk("/storage/research/Intern19_v2/segmentation/TestData/volume-" + str(i) + ".nii")
